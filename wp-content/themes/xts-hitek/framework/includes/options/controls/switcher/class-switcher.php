...
class Switcher extends Field {
	...
	public function render_control() {
		$on_text        = isset( $this->args['on-text'] ) ? $this->args['on-text'] : esc_html__( 'On', 'xts-theme' );
		$off_text       = isset( $this->args['off-text'] ) ? $this->args['off-text'] : esc_html__( 'Off', 'xts-theme' );
		$class_switcher = $this->is_activated() ? ' xts-active' : '';

		?>
			<div class="xts-switcher-btn<?php echo esc_attr( $class_switcher ); ?>">
