...
class Buttons extends Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'xts-buttons-control', XTS_FRAMEWORK_URL . '/integration/elementor/assets/js/buttons.js', [ 'jquery' ], XTS_VERSION, false );
	}

	/**
	 * Render xts_buttons control output in the editor.
	 *
