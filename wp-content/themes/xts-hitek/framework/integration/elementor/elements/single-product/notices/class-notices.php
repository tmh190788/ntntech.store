...
class Notices extends Widget_Base {
	...
	public function get_name() {
		return 'xts_single_product_notices';
	}
	...
	public function get_title() {
		return esc_html__( 'WooCommerce notices', 'xts-theme' );
	}
	...
	protected function render() {
		...
		xts_single_product_notices_template( $this->get_settings_for_display() );
