...
class Library_Source extends Source_Base {
	...
	public function get_title() {
		return esc_html__( 'XTemos', 'xts-theme' );
	}
	 ...
	 */
	private function get_template_content( $template_id, $blog_id ) {
		$response = wp_remote_get( XTS_DEMO_URL . 'tethys/?xts_action=xts_get_template&id=' . $template_id . '&blog_id=' . $blog_id );
	...
	public function get_data( array $args, $context = 'display' ) {
		if ( 'update' === $context ) {
			...
			$data = $this->get_template_content( $args['template_id'], $args['blog_id'] );
		}
