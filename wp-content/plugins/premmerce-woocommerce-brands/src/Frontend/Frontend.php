...
class Frontend
{
    ...
    private function registerHooks()
    {
        ...
        add_action('premmerce_brands_page_render', [$this, 'renderBrandsPage']);
    }
    ...
    {
        $args = apply_filters('premmerce_brands_page_pre_get_brands', [
        ...
        if ( ! is_wp_error($brands)) {
            $data = apply_filters('premmerce_brands_page_data', ['brands' => $brands]);
            ob_start();
